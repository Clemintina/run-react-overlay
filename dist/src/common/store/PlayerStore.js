...
import { RequestType, RunEndpoints } from "../utils/externalapis/RunApi";
export const getPlayerHypixelData = createAsyncThunk('PlayerStore/getPlayerHypixelData', async (thunkObject, { getState }) => {
    const playerData = {
