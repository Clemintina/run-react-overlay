export class PlayerUtils {
    ...
    getFormatPlayerInstance() {
        return this.formatPlayerInstance;
    }
    getPlayerHypixelUtils() {
        return this.playerHypixelUtils;
    }
}
export class FormatPlayer {
    constructor() {
        this.starterDivider = `<div style="margin: 0 auto; justify-content: center; display: flex;">`;
        this.utils = new PlayerHypixelUtils();
        this.renderTags = (player) => {
        ...
        this.renderRatioColour = (player, route) => {
            let renderer = this.starterDivider;
            let playerValue;
            if (!player.nicked) {
        ...
        this.getPlayerTagDivider = (tag, colour, player) => {
        ...
        this.getPlayerTagDividerNicked = () => {
...
export class PlayerHypixelUtils {
    constructor() {
        this.getPlayerRank = ({ player, formatting = false }) => {
            ...
            if (hypixelPlayer !== null) {
                ...
                if (hypixelPlayer.rankPlusColor !== undefined)
