 ...
 */
const IPCValidInvokeArray = ["hypixel", "seraph", "isAdmin", "autoLog", "mcutils", "selectLogFile", "isFileReadable", "boomza", "keathiz", "observer", "lunar", "playerdb", "tagsGet", "getWholeStore", "getFilePath", "notifications", "registerGlobalKeybinds", "getAppInfo", "astolfo", "openlink"] as const;
