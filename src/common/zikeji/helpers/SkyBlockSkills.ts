 ...
 * @category Helper
 */
export function getSkyBlockProfileMemberSkills(profileMember: Components.Schemas.SkyBlockProfileMember, skills: Components.Schemas.SkyBlockResourcesSkills): SkyBlockSkillsInfo | false {
	let hasApi = false;
