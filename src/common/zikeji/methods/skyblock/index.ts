...
export class SkyBlock extends Method {
     ...
     * @category API
     */
    public async auctions_ended(): Promise<ResultObject<Paths.SkyblockAuctionsEnded.Get.Responses.$200, ["success"]>> {
        return getResultObject(await this.client.call<Paths.SkyblockAuctionsEnded.Get.Responses.$200>("skyblock/auctions_ended"), ["success"]);
    }
     ...
     * @category API
     */
    public async bazaar(): Promise<ResultObject<Paths.SkyblockBazaar.Get.Responses.$200, ["products"]>> {
        return getResultObject(await this.client.call<Paths.SkyblockBazaar.Get.Responses.$200>("skyblock/bazaar"), ["products"]);
    }
     ...
     * @category API
     */
    public async news(): Promise<ResultArray<Paths.SkyblockNews.Get.Responses.$200, "items">> {
        return getResultArray(await this.client.call<Paths.SkyblockNews.Get.Responses.$200>("skyblock/news"), "items");
    }
