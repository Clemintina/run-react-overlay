...
export class FindGuild extends Method {
   ...
   * @category API
   */
  public async byName(name: Components.Parameters.ByGuildName.ByName): Promise<ResultObject<Paths.FindGuild.Get.Responses.$200, ["success"]>> {
   ...
   * @category API
   */
  public async byUuid(uuid: Components.Parameters.ByUuid.ByUuid): Promise<ResultObject<Paths.FindGuild.Get.Responses.$200, ["success"]>> {
    return getResultObject(
