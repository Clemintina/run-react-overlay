...
export class Guild extends Method {
     ...
     * @category API
     */
    public async id(id: Paths.Guild.Get.Parameters.Id): Promise<ResultObject<Paths.Guild.Get.Responses.$200, ["guild"]>> {
     ...
     * @category API
     */
    public async player(player: Paths.Guild.Get.Parameters.Player): Promise<ResultObject<Paths.Guild.Get.Responses.$200, ["guild"]>> {
        return getResultObject(
            await this.client.call<Paths.Guild.Get.Responses.$200>("guild", {
                player,
            }),
     ...
     * @category API
     */
    public async name(name: Paths.Guild.Get.Parameters.Name): Promise<ResultObject<Paths.Guild.Get.Responses.$200, ["guild"]>> {
        return getResultObject(
            await this.client.call<Paths.Guild.Get.Responses.$200>("guild", {
                name,
            }),
