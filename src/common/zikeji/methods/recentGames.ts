...
export class RecentGames extends Method {
     ...
     * @category API
     */
    public async uuid(uuid: Components.Parameters.PlayerUuidRequired.Uuid): Promise<ResultArray<Paths.RecentGames.Get.Responses.$200, "games">> {
        return getResultArray(
            await this.client.call<Paths.RecentGames.Get.Responses.$200>("recentGames", {
                uuid,
            }),
            "games",
        );
