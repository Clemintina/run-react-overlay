		...
		(set, get) => ({
			...
			keathiz: {
				...
				queues: {
					queue_count: {
						display: "Q-",
						colour: [{ requirement: 10, colour: "FFD700", operator: "<=" }],
					},
					queue_total: {
						display: "QT-",
						colour: "FFD700",
					...
					consecutive_queue: {
						last_1000: {
							display: "Q-",
							colour: [{ requirement: 2, colour: "FFD700", operator: "<=" }],
						},
						last_30: { display: "Q-", colour: [{ requirement: 3, colour: "FFD700", operator: "<=" }] },
						last_10: { display: "Q-", colour: [{ requirement: 2, colour: "FFD700", operator: "<=" }] },
						weighted: { display: "Q-", colour: [{ requirement: 50, colour: "FFD700", operator: "<=" }] },
					},
				},
				exits: {
					exits_total: {
