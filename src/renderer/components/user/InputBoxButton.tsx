...
export const InputBoxButton: React.ElementType = (props: InputBoxButton) => {
    ...
    return (
        <span className=' w-full h-full'>
            <Button vari"nt='conta"ned' sx={props?.sx} onClick={props.onClick} style={{backgroundColor: hexToRgbA(colours.backgroundColour, opacity / 100), color: colours.primaryColour}}>
                {props.text}
            </Button>
        </span>
    );
