...
export const PlayerOptionsModal: FC<PlayerOptionsModal> = ( { data, children } ) => {
	...
	return (
		<>
			<InputBoxButton onClick={ handleOpen } text={ "X" } options={ {
				variant : "outlined",
			} } sx={ { height : 25 } } />
			{ open ? <Modal open={ open } onClose={ handleClose } style={ { color : colours.primaryColour } }>
					<Box sx={ style }>
						<div className={ "" }>
							<div className={ "py-2" }>
								<FormControl fullWidth>
									...
									<div className={ "pt-4" }>
										...
										{ successful ? <div className={ "text-green-500 pt-3" }>Completed <CheckCircle /></div> : <span /> }
