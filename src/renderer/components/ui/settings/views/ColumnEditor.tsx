...
const ColumnEditorView = () => {
    ...
    const gridOptions: GridOptions<Player> = {
        ...
        onRowValueChanged(event: RowValueChangedEvent<Player>) {
            event.columnApi.applyColumnState({state: columnState, applyOrder: true});
        },
...
const generateRandomNumber = (param1, param2) => {
            ...
            lunar: {
                ...
                data: {
                    ...
                    player: {
                        ...
                        rank: {
                            unknownBooleanB: false,
                            unknownBooleanC: false,
                        },
                        unknown: {
