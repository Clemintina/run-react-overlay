...
type StrictIpcModule<ChannelMap extends StrictChannelMap, LooseModule extends NodeJS.EventEmitter> = Omit<LooseModule, "on" | "once" | "removeAllListeners" | "removeListener"> & {
